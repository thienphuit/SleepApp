...
import {
  anxious, kids, my, sleepIcon, allIcon, maskMeditate, play, daycalm, release, frameMeditate, treeMeditate,
} from '../../../assets/images'
                  ...
                  .map((item) => {
                    return (
                      <View style={{ marginBottom: 16 * calRepository }}>
                        <Image source={item.image} resizeMode="cover" style={{ width: 176 * calRepository, height: item.size * 176 * calRepository, borderRadius: 10 * calRepository }} />
                        <View style={{
